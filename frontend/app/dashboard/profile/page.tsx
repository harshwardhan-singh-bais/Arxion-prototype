...
function MetricCard({ title, value, sub }: { title: string; value: string | number; sub: string }) {
    return (
        <div className="p-6 bg-white/5 border border-[#1e293b]/30 relative overflow-hidden group hover:border-[#ef4444]/50 transition-colors">
            <h4 className="font-mono text-xs uppercase tracking-widest text-[#94a3b8] mb-2">{title}</h4>
            <div className="text-4xl font-display font-black text-white tracking-tighter mb-4">
                {value}
            </div>
            <div className="font-mono text-[9px] uppercase tracking-widest text-[#1e293b] flex items-center justify-between border-t border-[#1e293b]/20 pt-4">
                <span>{sub}</span>
                    ...
                    <UserButton
                        ...
                        appearance={{
                            elements: {
                                ...
                                avatarBox: "!rounded-full w-16 h-16 border-2 border-[#1e293b]/40",
            ...
            <div className="p-6 bg-white/5 border border-[#1e293b]/30">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center py-2">
                        ...
                        <span className="font-mono text-xs text-[#ef4444]">CLERK</span>
                    </div>
                </div>
            </div>
        </div>
